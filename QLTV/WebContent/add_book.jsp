					...
					<div class="card card-primary">
						...
						<form role="form" method="post"
							...
							<div class="card-body">
								...
								<div class="form-group">
									<label for="exampleInputFile">Thêm file ebook</label>
									<div class="input-group">
										<div class="custom-file">
											<input type="file" accept="application/pdf, application/msword"
												class="custom-file-input" id="customFileEbook" name="fileBook"
												required> <label class="custom-file-label"
												for="customFileEbook" style="color: #a6b0ba;">Thêm file ebook</label>
										</div>
									</div>
								</div>
							</div>
